...
| --- | --- | --- | --- |
| `martyrologium_romanum_1749/` | Benedict XIV revision, 1749 (public domain) | scan with OCR text layer, parsed mechanically | **raw, uncorrected OCR**: 365/365 days, 2,938 elogia, every day with titulus and conclusio; OCR artifacts remain in the texts (stray intra-word spaces, occasional misreads). **Aligned to CRMEDR IDs** (draft): 1,688 same-day + 103 cross-day matches, 1,147 coined deprecated IDs; see `alignment.json`. Proofreading and alignment review welcome. |
